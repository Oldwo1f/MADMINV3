...
.directive('addIngrediant', function(){
    ...
    return {
      	...
      	controller:function($state,$timeout,$scope,userService,$rootScope,ingrediantService,$mdToast,imageService,documentService, tagService, categoryService, $q, Upload,$sailsSocket){
