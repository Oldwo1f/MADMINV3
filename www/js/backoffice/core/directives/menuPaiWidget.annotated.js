...
angular.module('core')
  .directive('menuPaiWidget',["widgetService", "$compile", "$timeout", function (widgetService,$compile,$timeout){
    'use strict';
    ...
    return {
      scope: {},
      replace: true,
      templateUrl: 'js/backoffice/core/partials/menuPaiWidget.html',
