...
.directive('addIngrediant', function(){
    ...
    return {
      	...
      	controller:function($state,$timeout,$scope,userService,$rootScope,ingrediantService,fabricantService,$mdToast,imageService,documentService, tagService, categoryService, $q, Upload,$sailsSocket){
