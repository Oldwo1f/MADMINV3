angular.module('momi-pai')
  .directive('ingrediants', ["ingrediantService", function(ingrediantService){
    ...
    return {
		...
		controller:["$scope", "$rootScope", "userService", "ingrediantService", "tagService", "imageService", "documentService", "$sailsSocket", "$stateParams", "$state", "usSpinnerService", function($scope,$rootScope,userService,ingrediantService,tagService,imageService,documentService,$sailsSocket,$stateParams,$state,usSpinnerService){
			...
			$scope.changeSort=function(type){
				switch(type)
				{
					...
					break;
					case 'fabricant':
						if($scope.sort == 'fabricant DESC'){
							$scope.sort =	'fabricant ASC'
						}else{
						 	$scope.sort =	'fabricant DESC'
						}
					break;
					case 'status':
