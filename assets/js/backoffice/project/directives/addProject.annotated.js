...
.directive('addProject', function(){
    ...
    return {
      	...
      	controller:["$mdDialog", "$state", "$timeout", "$scope", "userService", "$rootScope", "projectService", "$mdToast", "imageService", "documentService", "tagService", "categoryService", "$q", "Upload", "$sailsSocket", function($mdDialog,$state,$timeout,$scope,userService,$rootScope,projectService,$mdToast,imageService,documentService, tagService, categoryService, $q, Upload,$sailsSocket){
