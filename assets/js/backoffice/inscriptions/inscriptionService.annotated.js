angular.module('lfbk-inscription')
.factory('inscriptionService', ["$http", "$q", "$sailsSocket", function ($http,$q,$sailsSocket) {
    var service = {};
    service.items=[];  
    service.me={};  
    ...
    service.create=function(newitem){
        ...
        var deferred = $q.defer();
        $sailsSocket.post('/api/inscription',newitem).success(function (data,status) {
            console.log('SUCCESS');
            deferred.resolve(data);
        }).error(function (data,status) {
