  ...
  .directive('agenda', function(){
    ...
    return {
		...
		replace: true,
      	...
      	controller:function($mdDialog,$scope,$rootScope,userService,tagService,categoryService,eventService,imageService,documentService,$sailsSocket,$stateParams,$state,usSpinnerService){
