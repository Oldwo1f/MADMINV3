angular.module('momi-pai')
  .directive('fabricants', function(fabricantService){
    ...
    return {
		...
		controller:function($scope,$rootScope,userService,fabricantService,tagService,imageService,documentService,$sailsSocket,$stateParams,$state,usSpinnerService){
			...
			$scope.changeSort=function(type){
				...
				$state.transitionTo('fabricants', { sort: $scope.sort,page:$scope.page,nbPerPage:$scope.nbPerPage}, {location:true});
				console.log('fetchFabricants');
