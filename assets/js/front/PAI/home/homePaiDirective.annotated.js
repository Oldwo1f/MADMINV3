angular.module('pai-home')
  .directive('homePai', ["tagService", "categoryService", function (tagService,categoryService){
    ...
    return {
		...
		controller :["Flash", "$window", "$state", "imageService", "userService", "fabricantService", "$scope", "$rootScope", "$q", "Upload", "$sailsSocket", "$timeout", function(Flash,$window,$state,imageService,userService,fabricantService, $scope, $rootScope, $q, Upload,$sailsSocket,$timeout){
