angular.module('pai-agenda')
  .directive('addEvent', function (){
    ...
    return {
		...
		controller :["Flash", "$window", "$state", "imageService", "tagService", "categoryService", "userService", "eventService", "$scope", "$rootScope", "$q", "Upload", "$sailsSocket", "$timeout", function(Flash,$window,$state,imageService,tagService,categoryService,userService,eventService, $scope, $rootScope, $q, Upload,$sailsSocket,$timeout){
