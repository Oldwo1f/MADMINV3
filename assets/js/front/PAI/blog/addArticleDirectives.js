angular.module('pai-blog')
  .directive('addArticle', function (){
    ...
    return {
		...
		controller :function(Flash,$window,$state,imageService,tagService,categoryService,userService,articleService, $scope, $rootScope, $q, Upload,$sailsSocket,$timeout){
