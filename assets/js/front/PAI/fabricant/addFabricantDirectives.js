angular.module('pai-fabricant')
  .directive('addFabricant', function (){
    ...
    return {
		...
		replace: true,
		templateUrl: 'js/front/PAI/fabricant/addFabricant.html',
			...
			$scope.finishedWizardAddContent = function(){
				...
				fabricantService.update($scope.formData.id,attrToUpdate).then(function(data){
					...
					userService.addCollabsPoints(userService.me.id,collabspoints).then(function(newcollabs){
						...
						fabricantService.addCollabsPoints($scope.formData.id,newcollabs.child.id).then(function(data){
		...
		link:function(scope,element,attrs){
			...
			console.log('LINKKKKKKKKKKKK add fabricant');
