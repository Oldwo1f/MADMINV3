angular.module('pai-ingredient')
  .directive('ingredient', ["articleService", function (articleService){
    ...
    return {
		...
		replace: true,
		templateUrl: 'js/front/PAI/ingredient/ingredients.html',
		controller :["$scope", "ingredientService", function($scope,ingredientService){
			...
			$scope.myPagingFunction = function(){
				...
				if($scope.fetching == false){
					...
					ingredientService.fetch($scope.page).then(function(data){
						console.log('FETCH');
						// console.log(data);
						if(data.length)
