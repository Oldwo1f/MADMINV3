angular.module('pai-ingredient')
  .directive('addIngredient', function (){
    ...
    return {
		...
		controller :["Flash", "$window", "$state", "imageService", "tagService", "categoryService", "userService", "fabricantService", "ingredientService", "$scope", "$rootScope", "$q", "Upload", "$sailsSocket", "$timeout", function(Flash,$window,$state,imageService,tagService,categoryService,userService,fabricantService,ingredientService, $scope, $rootScope, $q, Upload,$sailsSocket,$timeout){
