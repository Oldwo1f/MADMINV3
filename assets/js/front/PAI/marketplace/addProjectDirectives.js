angular.module('pai-marketplace')
  .directive('addProject', function (){
    ...
    return {
		...
		controller :function(Flash,$window,$state,imageService,tagService,categoryService,userService,projectService, $scope, $rootScope, $q, Upload,$sailsSocket,$timeout){
